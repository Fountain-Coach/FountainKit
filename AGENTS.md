...
- 3D stack focus — `Design/3D-Stack-Focus.md` (why we enforce Three.js + Cannon.js only).
- Working method — `Design/SRP-Spec-Reference-Parity.md` (Spec + Reference Parity for 3D work).
