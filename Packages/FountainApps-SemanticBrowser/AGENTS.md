...
- Control bridge status: JSCore midi2 bridge scaffold exists (`Midi2JSBridge`); extend to load full midi2.js bundle and expose `scheduleUMP` + capability feed to the stage. Wire planner to read `/webgpu/capabilities` and MIDI2 capability bitmap when selecting plans.
