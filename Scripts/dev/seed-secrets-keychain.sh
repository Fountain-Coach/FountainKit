...
#
# Usage examples:
#   Scripts/dev/seed-secrets-keychain.sh --gateway-bearer "$TOKEN" --openai-key "$OPENAI"
#   OPENAI_API_KEY=sk-... Scripts/dev/seed-secrets-keychain.sh
#   Scripts/dev/seed-secrets-keychain.sh --interactive
#
